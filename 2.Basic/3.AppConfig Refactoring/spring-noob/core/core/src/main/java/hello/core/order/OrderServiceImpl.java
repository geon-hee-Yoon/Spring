...
public class OrderServiceImpl implements OrderService{ //인터페이스만 의존->DIP만족
    //주문서비스는 2개의 필드가 필요
    private final MemberRepository memberRepository; //=new MemoryMemberRepository(); //회원 저장소에서 회원 찾아야 하므로.//수업자료 3.스프링 핵심 원리 이해2 참조
